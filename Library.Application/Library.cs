...
// 		{
// 			Console.Clear();
// 			Console.WriteLine("\x1b[31m\n\n\t\tCannot Add members right now. Error While Fetching Data Data\n\n\x1b[0");
// 			Console.ReadKey();
// 			return false;
// 		}
...
// 		{
// 			Console.Clear();
// 			Console.WriteLine("\x1b[31m\n\n\t\tCannot Update Members right now, Error While Fetching Data Data\n\n\x1b[0");
// 			Console.ReadKey();
// 			return false;
// 		}
//
// 		if (Members[memberIndex].MemberId != member.MemberId)
// 		{
// 			Console.Clear();
...
// 		{
// 			Console.Clear();
// 			Console.WriteLine("\x1b[31m\n\n\t\tError While Fetching Data Data\n\n\x1b[0");
// 			Console.ReadKey();
// 			return false;
// 		}
...
// 		{
// 			Console.Clear();
// 			Console.WriteLine("\x1b[31m\n\n\t\tThis Member cannot be deleted because it's have a related records in Books Data\n\n\x1b[0");
// 			Console.ReadKey();
// 			return false;
// 		}
//
...
// 		{
// 			Console.Clear();
// 			Console.WriteLine("\x1b[31m\n\n\t\tCannot Add books right now. Error While Fetching Data Data\n\n\x1b[0");
// 			Console.ReadKey();
// 			return false;
// 		}
...
// 		{
// 			Console.Clear();
// 			Console.WriteLine("\x1b[31m\n\n\t\tCannot Update Book right now. Error While Fetching Data Data\n\n\x1b[0");
// 			Console.ReadKey();
// 			return false;
// 		}
//
// 		if (Books[bookIndex].BookID != book.BookID)
// 		{
// 			Console.Clear();
...
// 		{
// 			Console.Clear();
// 			Console.WriteLine("\x1b[31m\n\n\t\tCannot Delete books right now. Error While Fetching Data Data\n\n\x1b[0");
// 			Console.ReadKey();
// 			return false;
// 		}
//
...
//
// 			Dictionary<int, string?> memberDictionary = Members.ToDictionary(m => m.MemberId, m => m.Name);
